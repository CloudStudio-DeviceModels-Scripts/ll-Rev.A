...
# Configuration Script – ll - Rev. A

This **Configuration** script is designed for the **ll** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – ll Rev. A

Este script de **Configuration** está diseñado para el modelo **ll** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
